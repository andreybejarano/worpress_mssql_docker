...
$("#bars").click(function(){$("#mobileNav").addClass("opened"),$("html").addClass("no-scroll")}),$("#open-nav").click(function(){$("#mobileNav").addClass("opened"),$("html").addClass("no-scroll")}),$("#close-nav").click(function(){$("#mobileNav").removeClass("opened"),$("html").removeClass("no-scroll")}),$(".nav-links .has-sub-menu .extra-holder").click(function(){$(this).parent().toggleClass("show-sub-menu")}),$(".coyuntura-col #year").change(function(e){var o=$(this).val();window.location.href=location.protocol+"//"+location.host+location.pathname+"?"+o}),$("#select-destacados").click(function(){$("#list-destacados").toggleClass("opened")}),$(document).ready(function(){if($('[data-fancybox="gallery"]').fancybox({}),$("body").hasClass("home"))new Swiper(".home .vertical-slider.swiper-container",{direction:"vertical",loop:!0,slidesPerView:3,spaceBetween:20,freeMode:!0,grabCursor:!0,autoHeight:!0,navigation:{nextEl:".swiper-button-next"},breakpoints:{}});else new Swiper(".vertical-slider.swiper-container",{direction:"horizontal",loop:!0,slidesPerView:1,navigation:{nextEl:".next-btn"},breakpoints:{480:{direction:"vertical",spaceBetween:20}}});new Swiper(".gallery-holder .swiper-container",{autoHeight:!0,autoplay:{delay:3e3},pagination:{el:".gallery-holder .swiper-pagination"},navigation:{nextEl:".gallery-holder .swiper-button-next"}})});